    ...
    <div className="App" id={theme}>
      ...
      {!isMenuActive &&
        <>
          ...
          <AboutMeSection theme={theme} section="about" title={language === "english" ? "One pleasure..." : "Un placer..."}>
            {language === "english" ?
              <>
              ...
              <>
                ...
                <p> Cree proyectos para mi ultimo trabajo (puesto de administracion) como este CRM que desarrollé para mejorar la eficacia de mis tareas diarias, e hice su
