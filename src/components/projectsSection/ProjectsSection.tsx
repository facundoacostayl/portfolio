  ...
  return (
    <section className={`${theme === "dark" ? styles.dark : styles.light}`} id="projects">
      <div className={`${styles.container}`}>
        ...
        <ProjectItem theme={theme} project="edendesk" title="EdenDesk CRM" subtitle="Real Project" image="https://www.sitesaga.com/wp-content/uploads/2020/04/what-is-website-how-it-works.png">
        ...
        <ProjectItem theme={theme} project="proviamo" title="Proviamo's E-Commerce" subtitle="Real Project" image="https://www.sitesaga.com/wp-content/uploads/2020/04/what-is-website-how-it-works.png">
        ...
        <ProjectItem theme={theme} project="marketlist" title="Marketlist against Inflation" subtitle="Personal Project" image="https://www.sitesaga.com/wp-content/uploads/2020/04/what-is-website-how-it-works.png">
        ...
        {isMoreOpened &&
          <ProjectItem theme={theme} project="caloriesCalculator" title="Harris Benedict Calculator" subtitle="Personal Project" image="https://www.sitesaga.com/wp-content/uploads/2020/04/what-is-website-how-it-works.png">
